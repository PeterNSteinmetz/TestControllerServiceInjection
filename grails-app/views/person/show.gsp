	...
	<body>
		...
		<div id="show-person" class="content scaffold-show" role="main">
			...
			<ol class="property-list person">
				...
				<g:if test="${personInstance?.person}">
				<li class="fieldcontain">
					<span id="person-label" class="property-label"><g:message code="person.person.label" default="Person" /></span>
					
						<span class="property-value" aria-labelledby="person-label"><g:fieldValue bean="${personInstance}" field="person"/></span>
