			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="person" title="${message(code: 'person.person.label', default: 'Person')}" />
				...
				<g:each in="${personInstanceList}" status="i" var="personInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${personInstance.id}">${fieldValue(bean: personInstance, field: "person")}</g:link></td>
